...
y1 = A1*math.sin((w1*t)+phi1)          # wave displacement
y2 = A2*math.sin((w2*t)+phi2)

y_res = y1 + y2                    # resulting combined wave
...
plt.show()
        ...
        # # https://opticspy.github.io/lightpipes/MichelsonInterferometer.html
        # # or maybe https://www.geeksforgeeks.org/plot-the-phase-spectrum-in-python-using-matplotlib/
        # #! /usr/bin/env python
        #
